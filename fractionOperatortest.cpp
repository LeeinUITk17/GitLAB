...
public:
	...
	friend fraction operator+(fraction const& obj);
	//friend fraction operator+(fraction const&res,int a);
...
fraction operator+(fraction const& obj) {
	fraction res;
	res.numerator = res.numerator * obj.denominator + obj.numerator * res.denominator;
	res.denominator = res.denominator * obj.denominator;
	res.simplifying_fraction(res);
	return res;
}
fraction fraction::operator+(int a) {
	fraction res;
	res.numerator = numerator + a * res.denominator;
